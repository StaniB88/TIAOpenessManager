...
Das Model Context Protocol (MCP) ermöglicht KI-Assistenten wie Claude, auf Ihr TIA Portal Projekt zuzugreifen.
...
2. Konfigurieren Sie Claude mit der MCP-Server-Adresse
3. Claude kann nun:
